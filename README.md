...
**Board:**
The Board class represents the board. It has the following method:
* init and get_board: sets up and gets the board
* update_board(self, color, row, column): updates the board pieces after the player has chosen an available position to place their piece
* piece_counts(self): counts the number of pieces for the two players
...
The main file is named **Othello.py**
